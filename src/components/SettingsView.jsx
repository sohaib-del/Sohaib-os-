  ...
  try {
    ...
    return (
      <div className="animate-in fade-in duration-300">
        <div style={{ padding: '10px', background: 'rgba(34, 197, 94, 0.1)', color: 'var(--green)', fontSize: '10px', marginBottom: '10px', borderRadius: '4px', border: '1px solid var(--green)' }}>
          DEBUG: Settings Page Attempting Render...
        </div>
    ...
    console.error("SettingsView Crash:", error);
    return <div className="p-8 text-red-500 mono">CRITICAL RENDER ERROR: {error.message}</div>;
  }
}
